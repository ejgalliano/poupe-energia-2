...
export default function CashbackCadastros() {
  ...
  // ── Export CSV ──
  const exportCSV = () => {
    const header = ["Data", "Nome", "CPF/CNPJ", "Telefone", "Email", "Distribuidora", "Fornecedora", "UC", "Consumo kWh", "Valor Conta", "Classe", "Cód Parceiro", "Valor Cashback", "Status", "Data Pagamento"];
