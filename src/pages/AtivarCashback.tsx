      ...
      <main className="flex-1 flex items-start justify-center px-4 py-10">
        <div className="w-full max-w-2xl">
          ...
          <div className="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden">
            ...
            {/* Header */}
            <div className="bg-brand-blue px-8 pt-8 pb-6">
              <div className="flex items-center gap-4">
                <div className="h-14 w-14 rounded-full bg-white/20 flex items-center justify-center shrink-0">
                  <FileText className="h-7 w-7 text-white" />
                </div>
                <div>
                  <p className="text-white/70 text-sm font-medium">Formulário de Adesão</p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#20b958] text-white text-sm font-bold px-5 py-2.5 rounded-xl transition"
                    >
